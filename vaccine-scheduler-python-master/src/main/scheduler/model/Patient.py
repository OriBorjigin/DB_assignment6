...
class Patient:
    def __init__(self, username, phone_number=None, password=None, salt=None, hash=None):
    ...
    def save_to_db(self):
        ...
        add_patients = "INSERT INTO Patients VALUES (%s, %s, %s, %s)"
        try:
            cursor.execute(add_patients, (self.username, self.phone_number, self.salt, self.hash))
