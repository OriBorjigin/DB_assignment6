...
class Caregiver:
    def __init__(self, username, name=None, phone_number=None, password=None, salt=None, hash=None):
    ...
    def save_to_db(self):
        ...
        add_caregivers = "INSERT INTO Caregivers VALUES (%s, %s, %s, %s, %s)"
        try:
            cursor.execute(add_caregivers, (self.username, self.name, self.phone_number, self.salt, self.hash))
